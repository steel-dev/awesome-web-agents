...
- [Haunt API](https://hauntapi.com/) - AI-powered web extraction API with Cloudflare bypass. Pay-per-use ($0.01/req), no monthly minimums. MCP server available for AI agents. ![PyPI](https://img.shields.io/pypi/v/hauntapi)
